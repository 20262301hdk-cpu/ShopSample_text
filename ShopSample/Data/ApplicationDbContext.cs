    ...
    public class ApplicationDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product { Id = 7, Name = "ばなな", Price = 125, CategoryId = 1 },
                new Product { Id = 8, Name = "スマートフォン", Price = 120000, CategoryId = 2 },
                new Product { Id = 9, Name = "ASP.NET Core MVC入門", Price = 3200, CategoryId = 3 }
            );
